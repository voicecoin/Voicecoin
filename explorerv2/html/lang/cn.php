...
function lang($phrase){
 ...
 'CHAIN_COIN' => '块链币龄销毁 [天/币]',
                ...
                'POW_DIFFICULTY' => 'VDPOS 难度系数',
                'THERE_TRANSACTIONS' => '目前没有未确认的交易.',
                'TRANSACTION_VOLUME' => '交易总量',
                'TX_ID' => '交易ID',
                'UNCONFIRMED_TRANSACTIONS' => '未确认交易',
                'VALUE_EMC' => '转出总量 [VC]',
                'WELCOME_EXPLORER' => '欢迎来到语音币(voicechain)区块浏览器',
                'ADDRESS_TX' => '钱包地址/区块/交易/域名',
                'CHAIN_CHAIN' => '区块链',
                'CHARTS_CHARTS' => '图表',
                ...
                'LABEL_LABEL' => '标注',
                'LOGIN_LOGIN' => '登陆',
                'NAME_DELETE' => '删除语音域名值存储系统(VNS)',
                'NAME_NAME' => '语音域名',
                'NEW_NAME' => '语音域名值(VNS)',
                'NAME_UPDATE' => '更新语音域名(VNS)',
                'NEW_ADDRESS' => '新钱包地址',
                'NEW_ENTRY' => '新增地址标签',
                'NVS_NVS' => '语音域名值存储系统（VNS）',
                'OR_OR' => '或',
                ...
                'EMCSSL_HIGH' => '使用VCSSL [高安全]',
                'EMCSSL_LOW' => '使用VCSSL或密码 [低安全]',
                'EMCSSL_DEACTIVATE' => '解除VCSSL证书登陆绑定',
                'YOUR_CERTIFICATE' => '您的VCSSL证书',
                'YOU_LOGIN' => '您可以使用VCSSL来保证您的登陆安全。',
                'WHAT_EMCSSL' => '什么是VCSSL?',
                'EMCSSL_SET' => 'VCSSL设置已保存',
                ...
                'STOCK_BTC' => '市场价 - VC/BTC',
                'STOCK_USD' => '市场价 - VC/USD',
                'STAKE_PERIOD' => '本时段利息',
                'EARNED_STAKE' => '利息收入',
                'AVERAGE_AT' => '均价',
                'VWAP_VWAP' => '成交量加权均价',
                ...
                'SEND_COINS' => '发送VC',
                'THIS_SUBSTRACTBALANCE' => '该笔交易将从您的余额中消耗"+ (parseFloat(amount)+parseFloat(fee)) +"VC。',
                'THIS_SUBSTRACTBALANCE2' => '该笔交易将从您的余额中消耗 "+amount+" VC。',
                ...
                'REGISTER_PAIR' => '注册语音域名->值',
                'UPDATE_PAIR' => '更新语音域名->值',
                'DELETE_PAIR' => '删除语音域名->值',
                'REGISTER_NAME' => '注册语音域名',
                'THE_LATER' => '钱包客户端提供直接发币到姓名的可能，该姓名将映射到一个新的注册地址。
币将发送至该新地址，该地址不会在您的账户内创建，您稍后可将该注册地址更改至您自己所拥有的某一确定地址或其他地址。',
                'ADDITIONAL_DAYS' => '增加额外天数',
                'UPDATE_NAME' => '更新语音域名值存储系统',
                'MOVE_ADDRESS' => '转移语音域名至其它钱包地址',
                'DELETE_NAME' => '删除语音域名值存储系统',
                'NAME_REGFEES' => '语音域名注册费',
                'NAME_UPFEES' => '语音域名更新费',
                'NAME_CONFIRMED' => '语音域名已注册成功！请等待确认！',
                'NAME_DELETED' => '语音域名已删除',
                'NAME_UPSUCCESS' => '语音域名已更新成功',
                'THIS_NAMETAKEN' => '该语音域名已注册',
                'BLOCK_DETAILS' => '区块详情',
		'NAME_DETAILS' => '域名详情',
                'HASH_HASH' => '哈希值',
                'TIME_TIME' => '时间',
                ...
                'MAINTENANCE_MAINTENANCE' => 'voicechain 区块浏览器正在维护，请稍后！',
				'UNKNOWN_TRANSACTIONS' => '未知交易',
				'NO_TXPROVIDED' => '尚无交易数据',
				'TRACE_OF' => '追踪于',
				'CLAIM_NAME' => '认领语音域名',
                'CLAIM_INFO' => '如果您已将语音域名转移到您的在线钱包地址（通过"语音域名更新"），您可在此认领语音域名所有权。',
                'NAME_CLAIMED' => '您已认领了此语音域名。',
                'NAME_BELONG' => '该语音域名同您的钱包地址不匹配，也许不属于您。',
                'NAME_NOTREGISTERED' => '该语音域名未注册。',
