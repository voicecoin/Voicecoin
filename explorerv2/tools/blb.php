...
function getblockinfo($dbconn, $emercoin, $hash) {
	...
	if (isset($block['previousblockhash'])){
	   echo 'previousblockhash'.$block['previousblockhash'].'\n';echo '\n';
	...
	$current_status="";
        ...
        echo 'hash_in_db='.$hash_in_db.",current_status=".$current_status.'\n';echo '\n';
...
// genesis block
$hash="0d2dca88acac7381e173eda4a25d54be7e04ab64c6fca946c1fea44de1853f3d";
