...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Bitcoin Core and Namecoin developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Bitcoin Core and Namecoin"
...
#define PACKAGE_STRING "Namecoin Core 0.15.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "namecoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://www.namecoin.org/"
